...
filepath= os.path.join(r"C:\Users\User\Desktop\Game Launcher v 1.0.0\ConnectDATA",'Connectbotlog-' + temps + '.txt')
...
def main():
    ...
    active = False
    text = 'Thanks for playing,you will be now redirected to the game menu'
    done = False
