...
filepath= os.path.join(r"C:\Users\User\Desktop\Game Launcher v 1.0.0\PongDATA",'pongAI-' + temps + '.txt')
...
### set window caption
pygame.display.set_caption("PONG Player VS BOT")
...
while (True):
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            f.write("Last played game today was at " + H + "\n" + "First player score : " + str(p1_score) + "\n" + "Second player score : " + str(p2_score) + "\n" )
            f.close()
            pygame.quit()
            exit()
        # get players keys
