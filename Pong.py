...
filepath= os.path.join(r"C:\Users\User\Desktop\Game Launcher v 1.0.0\PongDATA",'pong-' + temps + '.txt')
if not os.path.exists(r"C:\Users\User\Desktop\Game Launcher v 1.0.0\PongDATA"):
    os.makedirs(r"C:\Users\User\Desktop\Game Launcher v 1.0.0\PongDATA")
f = open(filepath, "a")
...
pygame.display.set_caption("One VS One Pong")
...
def draw(canvas):
    ...
    label1 = myfont1.render("Score " + str(l_score), 1, (255, 255, 200))
    canvas.blit(label1, (50, 20))

    myfont2 = pygame.font.SysFont("Comic Sans MS", 20)
    label2 = myfont2.render("Score " + str(r_score), 1, (255, 255, 200))
    canvas.blit(label2, (470, 20))
   
'''def savescore():
    f.write("Last played game today was at " + H + "\n" + "First player score : " + str(l_score) + "\n" + "Second player score : " + str(r_score) + "\n" )
    f.close()
    pygame.display.quit()
    pygame.quit()
    sys.exit()
