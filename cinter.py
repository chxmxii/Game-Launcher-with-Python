...
pygame.mixer.init()
def playovso():
 pipe=os.popen("connect.py")
 pipe=os.popen("Compteur.py")
 mw.destroy()
def playvsb():
 pipe=os.popen("cbot.py")
 pipe=os.popen("Compteur.py")
 mw.destroy()
def quitc():
    pipe=os.popen("Glauncher.py")
    mw.destroy()
    pygame.mixer.music.load("mond.mp3") #Loading File Into Mixer
...
Playovo = tk.Button(master=back, text='Play one vs one', command= playovso,width='100', borderwidth=3, bg='Ivory', activebackground='orange')
Playovo.pack()
Playovo.place(relx=0.5, rely=0.5, anchor="n")
Playovb = tk.Button(master=back, text='Play vs BOT ', command= playvsb,width='100', borderwidth=3, bg='Ivory', activebackground='orange')
Playovb.pack()
Playovb.place (relx =0.5, rely=0.6,anchor='center')
close = tk.Button(master=back, text='Back to menu', command= quitc,width='100', borderwidth=3, bg='Ivory', activebackground='orange')
close.pack()
close.place (relx =0.5, rely=0.7,anchor='s')

Music = tk.Button(mw,text="Enable music",command=play,borderwidth=2, bg='Ivory', activebackground='orange')
Music.pack()
...
pygame.mixer.music.load("mond.mp3") 
